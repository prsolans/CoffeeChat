...
function ajaxTime() {
  $.ajax({
	type: 'GET',
	url: 'time.php',
	data: 'school=12&date='+document.getElementById("date").value+'&date2='+document.getElementById("date").name,
...
<p>A.T. Kearney consultants will be hosting Coffee Chats with 1st Year Wharton MBAs on Friday, November 18th.  We will be hosting the coffee chats at Cosi at 1720 Walnut (near Rittenhouse Sq.).  We will be available to answer questions about A.T. Kearney's Summer Internship Program, the work we do, and the culture we promote. Please fill in the information below and press submit to reserve your spot.</p><p>Note that the following eligibility requirements must apply to sign up for the Coffee Chat or be considered for a full time position at A.T. Kearney: 
<ul><li>Currently enrolled in the Full Time MBA program</li> 
<li>Graduating from the Full Time MBA program in May 2013</li> 
<li>Able to start the summer program at A.T. Kearney in May or June 2012</li></ul> 

<form action="/coffeeChat/wharton_submit.php" name="coffeeChatBooth">
<table>
  <tr>
    <td class="table_label">Coffee Chat Date</td>
    <td><?php	 	 		 		 	 	 		 		 		 		 		 	 
$datesQuery = 'SELECT id, slot_date FROM `__global`.`x_rec_chatdates` WHERE schoolID = 12 AND active = 0 ORDER BY slot_date;';
