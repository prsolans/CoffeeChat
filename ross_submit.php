...
// ADD NEW STUDENT TO SCHOOL AT SPECIFIC DATE/TIME	
	...
	$addStudent = "INSERT INTO `joomla`.`".$theseRegistrants."` (dateID, timeID, firstName, lastName, email) VALUES ('".$dateID."', '".$timeID."', '".$firstName."', '".$lastName."', '".$email."');";		
	//echo $addStudent;		
...
$to      = 'RossMBA1Recruting@atkearney.com';
$subject = 'Ross School of Business Coffee Chat Registration';
$message = '<html><h2>Registration Form: Ross MBA1 Summer Internship Coffee Chats</h2><br/>';
