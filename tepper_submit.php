...
// ADD NEW STUDENT TO SCHOOL AT SPECIFIC DATE/TIME	
	...
	$addStudent = "INSERT INTO `joomla`.`".$theseRegistrants."` (dateID, timeID, firstName, preferredName, lastName, email, phone, industry, learn) VALUES ('".$dateID."', '".$timeID."', '".$firstName."', '".$preferredName."', '".$lastName."', '".$email."', '".$phone."', '".$industry."', '".$learn."');";		
	//echo $addStudent;		
...
$to      = 'TepperMBA1Recruting@atkearney.com';
$subject = 'Tepper School of Business Coffee Chat Registration';
$message = '<html><h2>Registration Form: Tepper School of Business 1st Year MBA Coffee Chat for A.T. Kearney Summer Associate Position</h2><br/>';
...
$headers = 'From: TepperMBA1Recruting@atkearney.com' . "\r\n" .
    'Reply-To: TepperMBA1Recruting@atkearney.com' . "\r\n" .
