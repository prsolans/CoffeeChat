...
// ADD NEW STUDENT TO SCHOOL AT SPECIFIC DATE/TIME	
	...
	$addStudent = "INSERT INTO `joomla`.`".$theseRegistrants."` (dateID, timeID, firstName, preferredName, lastName, email, phone, questions) VALUES ('".$dateID."', '".$timeID."', '".$firstName."', '".$preferredName."', '".$lastName."', '".$email."', '".$phone."', '".$questions."');";		
	//echo $addStudent;		
...
$to      = 'KelloggMBA1Recruiting@atkearney.com';
$subject = 'Kellogg School of Management Coffee Chat Registration';
$message = '<html><h2>Registration Form: Kellogg MBA1 AT Kearney Coffee Chats</h2><br/>';
...
$message .= $learn;
$message .= '<br/><strong>Do you have any specific questions about AT Kearney?</strong><br/>';
$message .= $questions;
$message .= '<p>Join mailing list: '.$mailingList;
*/


$headers = 'From: KelloggMBA1Recruiting@atkearney.com' . "\r\n" .
    'Reply-To: KelloggMBA1Recruiting@atkearney.com' . "\r\n" .
...
<div style="border: solid #A29789 36px; background: white; padding: 35px 22px 50px 22px; font-family: Arial, Helvetica, sans-serif;"><p>
Thank you for submitting your coffee chat request.  You are currently scheduled to meet at <?php	 	 		 		 	 	 		 		 		 		 		 	 echo $confirmedTime;?> on <?php	 	 		 		 	 	 		 		 		 		 		 	 echo $confirmedDate;?>.  We look forward to meeting with you.</p><p>If you need to change your time slot or have any other questions or concerns, please contact <A href="mailto:KelloggMBA1Recruiting.com?subject=Coffee Chat Signup">KelloggMBA1Recruiting</a> at <A href="mailto:KelloggMBA1Recruiting@atkearney.com?subject=Coffee Chat Signup">KelloggMBA1Recruiting@atkearney.com</a>.</b></p><p>Learn more about Careers at A.T. Kearney: <a href="http://www.atkearney.com/index.php/Careers/career-path.html">Career Path</a> | <a href="http://www.atkearney.com/index.php/Careers/global-mobility-program.html">Global Mobility Program</a> | <a href="http://www.atkearney.com/index.php/Careers/mentoring.html">Mentoring</a> | <a href="http://www.atkearney.com/index.php/Careers/training.html">Training</a></div>
