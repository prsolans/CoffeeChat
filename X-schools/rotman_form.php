...
<h1>Registration Form: Rotman MBA1 Summer Internship Coffee Chats</h1>
...
function ajaxTime() {
  $.ajax({
	...
	data: 'school=10&date='+document.getElementById("date").value+'&date2='+document.getElementById("date").name,
...
<p>A.T. Kearney consultants will be on campus throughout the Fall quarter to answer your questions and share our consulting experiences in a less formal and more personal manner.</p>
<p>To sign up for a Coffee Chat, please fill in the form below.
</p>
...
<table>
  <tr>
    ...
    <td><?php	 	 		 		 	 	 		 		 		 		 		 	 
$datesQuery = 'SELECT id, slot_date FROM `joomla`.`x_rec_chatdates` WHERE schoolID = 10 AND active = 0 ORDER BY slot_date;';
