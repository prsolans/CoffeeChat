...
$subject = 'GALA Coffee Chat Registration';
$message = '<html><h2>Registration Form: GALA Coffee Chats for 2013</h2><br/>';
...
$headers = 'From: GALARecruting@atkearney.com' . "\r\n" .
    'Reply-To: GALARecruting@atkearney.com' . "\r\n" .
...
<p>
Thank you for submitting your coffee chat request.  You are currently scheduled to meet at <?php	 	 		 		 	 	 		 		 		 		 		 	 echo $confirmedTime;?> on <?php	 	 		 		 	 	 		 		 		 		 		 	 echo $confirmedDate;?>.  We look forward to meeting with you.</p><p>If you need to change your time slot or have any other questions or concerns, please contact <a href="mailto:Danielle.Limbal@atkearney.com?subject=GALA Coffee Chats">Danielle Limbal</a></b>.</p></div>
