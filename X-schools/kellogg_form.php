...
<h1>Registration Form: Kellogg MBA1 AT Kearney Coffee Chats</h1>
...
function ajaxTime() {
  $.ajax({
	...
	data: 'school=6&date='+document.getElementById("date").value+'&date2='+document.getElementById("date").name,
...
<p> A.T. Kearney consultants will be in Evanston on Friday October 29th and Friday November 12th to answer your questions and share their consulting experiences in a less formal and more personal manner. An e-mail will be sent to all participants the week of the coffee chat to confirm location.  </p>
<p>To sign up for a Coffee Chat, please answer the questions below. Note that the coffee chats are only intended for first year MBA students. 
</p>
<form action="http://www.atkearney.com/images/test/coffeeChat/kellogg_submit.php" name="coffeeChatBooth">
<table>
  <tr>
    <td class="table_label">Coffee Chat Date</td>
    <td><?php	 	 		 		 	 	 		 		 		 		 		 	 
$datesQuery = 'SELECT id, slot_date FROM `joomla`.`x_rec_chatdates` WHERE schoolID = 6 AND active = 0 ORDER BY slot_date;';
...
-->  <tr>
    <td class="table_label"> Do you have any specific questions about AT Kearney?</td>
    <td><textarea class="cf_inputbox" rows="3" id="text_13" title="" cols="30" name="questions"></textarea></td>
  </tr>
   <tr>
    <td></td>
